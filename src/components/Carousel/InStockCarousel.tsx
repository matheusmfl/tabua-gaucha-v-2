...
export const CustomDotGroup: React.FC<CustomDotGroup> = ({ onClick, carouselState, active }) => {
  ...
  return (
    <button onClick={() => onClick()} className={` ${active ? 'w-10 bg-stone-100' : 'w-2 bg-stone-400'} transition-width duration-300 rounded-full opacity-80 ml-2 h-2`} />
  )
}
...
export function InStockCarousel() {
  const totalItems = 6
  return (
    <div className="pb-9">
      ...
      >
        ...
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" discountAmount={50} />
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" />
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" discountAmount={90} />
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" discountAmount={50} />
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" />
        <InStockCard description="Mesa de canto" price={16999} title="Black Automatic Watch" discountAmount={90} />
      </Carousel>
